...
global.footer = "༒︎ Matti Elladuthum Petro Enn Akk ༒︎" //footer section
global.status = false //"self/public" section of the bot
global.prefa = ['','!','.','#','&','/','@']
global.owner = ['234']
global.xprefix = '.'
global.gambar = "https://i.postimg.cc/NMn8rzqh/image1.png"
global.OWNER_NAME = "@matti_elladuthum_petro_enn_akk" //
global.DEVELOPER = ["7848300179"] //
global.BOT_NAME = "Matti Elladuthum Petro Enn Akk"
global.bankowner = "Matti Elladuthum Petro Enn Akk"
global.creatorName = "Matti Elladuthum Petro Enn Akk"
...
global.creatorName = "☠︎︎ 𓆩�𝒆𝒕𝒓𝒐 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍𓆪 ☠︎︎'"
global.footer = "☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑴𝑫 ☠︎︎" //footer section
global.link = "https://whatsapp.com/channel/0029Vb6iopUDzgTJuzPCk32V"
global.autobio = true//auto update bio
global.botName = "☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑴𝑫 ☠︎︎"
global.version = "V2"
global.botname = "☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑴𝑫 ☠︎︎"
global.author = "༒︎ 𝑷𝑬𝑻𝑹𝑶 ༒︎"
global.themeemoji = '🤞'
...
global.ownername = '☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍 ☠︎︎' 
global.onlyowner = `☠️ 𝙎𝙤𝙧𝙧𝙮, 𝙏𝙝𝙞𝙨 𝙁𝙚𝙖𝙩𝙪𝙧𝙚 𝙄𝙨 𝙍𝙚𝙨𝙩𝙧𝙞𝙘𝙩𝙚𝙙 𝙏𝙤 𝙊𝙬𝙣𝙚𝙧𝙨 𝙊𝙣𝙡𝙮.  
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *Matti Elladuthum Petro Enn Akk* 𝙩𝙤 𝙜𝙖𝙞𝙣 𝙤𝙬𝙣𝙚𝙧 𝙥𝙧𝙞𝙫𝙞𝙡𝙚𝙜𝙚𝙨.  
🕳️ 𝙄𝙡𝙡𝙚𝙜𝙖𝙡 𝙖𝙘𝙘𝙚𝙨𝙨 𝙬𝙞𝙡𝙡 𝙗𝙚 𝙘𝙡𝙚𝙖𝙣𝙨𝙚𝙙 𝙗𝙮 𝙩𝙝𝙚 𝑻𝒂𝒍𝒉𝒂.`
  // reply 
global.database = `☠️ 𝙏𝙤 𝙗𝙚 𝙖𝙙𝙙𝙚𝙙 𝙩𝙤 𝙩𝙝𝙚 𝘿𝘼𝙏𝘼𝘽𝘼𝙎𝙀 𝘽𝘼𝙎𝙀...  
🩸 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 *PETRO* — 𝙊𝙧 𝙗𝙚 𝙚𝙧𝙖𝙨𝙚𝙙 𝙗𝙮 𝙙𝙚𝙛𝙖𝙪𝙡𝙩.  🔗 *No entry without approval.*`
  global.mess = {
wait: "```☠️ WAIT FOR  ☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑴𝑫 ☠︎︎😈 ⚡ *Darkness intensifies...*  💀 *Brace yourself — The PETRO is rising.*```",
   success: "✔️ 𝗦𝗨𝗖𝗖𝗘𝗦𝗦 𝗕𝗬 ☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑴𝑫 ☠︎︎ ⚔️`  🔥 *Mission complete. The Void accepts your command.*",
   on: "`✔️☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑴𝑫 ☠︎︎𝗔𝗖𝗧𝗜𝗩𝗘 ⚔️`  🔥 *The PETRO is unleashed. Power running at full force.*  🕳️ *Enter if you dare.*", 
   prem: "`⛧ PREMIUM ACCESS ONLY ⛧`  🩸 *This feature is restricted to premium users.*  📲 *Add your number to the database to unlock the dark tier.*  🕳️ *No entry without clearance. The PETRO does not negotiate.*", 
   off: "`❌ ☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑴𝑫 ☠︎︎𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗢𝗙𝗙 ⚰️`  🕳️ *The PETRO has gone dark. All systems offline.*  ⚡ *Recharge and prepare for the next awakening.*",
   query: {
...
private: "Sorry bro, This Feature Can Only Be Used In Private Chats",
       owner: "Sorry bro, This Feature Can Only Be Used by ☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍 ☠︎︎brr😋",
...
global.onlyowner = `\`[ 🤞 ] ☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑴𝑫 ☠︎︎ \` \n*
...
global.database = `\`[ 👑 ] ☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑴𝑫 ☠︎︎ 😙 \` \n*
...
𝕋𝕙𝕒𝕟𝕜𝕤 𝕗𝕠𝕣 𝕌𝕤𝕚𝕟𝕘  ☠︎︎ 𝑷𝒆𝒕𝒓𝒐 𝑴𝑫 ☠︎︎`
